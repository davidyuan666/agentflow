...
class Agent(Protocol):
    ...
    An agent can communicate with other auto_agent and perform actions.
    Different auto_agent can differ in what actions they perform in the `receive` method.
    """
    ...
    def generate_reply(
        ...
        **kwargs: Any,
        ...
        Args:
            messages (list[dict]): a list of messages received from other auto_agent.
